...
<table border="0.8">
    ...
    <tr>
        <td>/asset/v3/private/transfer/inter-transfer</td><td rowSpan="4">20 req/s</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/asset/v3/private/transfer/inter-transfer/list/query</td><td rowSpan="7">60 req/s</td>
    </tr>
    <tr>
...
<table border="0.8">
    ...
    <tr>
        <td>/asset/v3/public/deposit/allowed-deposit-list/query</td><td rowSpan="4">300 req/s</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/asset/v3/private/withdraw/cancel</td><td>60 req/s</td>
    </tr>
    <tr>
        <td>/asset/v3/private/withdraw/create</td><td>10 req/s</td>
    </tr>
    <tr>
...
<table border="0.8">
    ...
    <tr>
        <td>/user/v3/private/create-sub-member</td><td rowSpan="7">300 req/s</td>
    </tr>
    <tr>
