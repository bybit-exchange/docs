...
|:----- |:-------|:-----|------ |
|[category](../../enum#category) |false |string |Product type. `linear`(default),`inverse`,`option`(temporary unavailable) |
...
|[positionIdx](../../enum#positionidx) |false |string |Position index. It is **required** for hedge position mode |
