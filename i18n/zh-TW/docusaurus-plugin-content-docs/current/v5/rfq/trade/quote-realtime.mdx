...
:::info
<ul><li>獲取使用者發送或接收的報價資訊，從 rfq-engine 查詢，無延遲</li></ul>
<ul><li>同時傳遞 quoteId 和 quoteLinkId 時，以 quoteId 為準，優先順序：quoteId > quoteLinkId > rfqId</li></ul>
<ul><li>根據報價的創建時間倒序排列</li></ul>
<ul><li>返回所有非最終報價</li></ul>
<ul><li>在極端市場波動期間, 此介面可能會出現延遲增加或資料傳遞暫時延遲的情況</li></ul>
:::
