...
<sbe:messageSchema xmlns:sbe="http://fixprotocol.io/2016/sbe" package="order.trading.api.sbe" id="2" version="2" semanticVersion="1.0.0" description="Order Trading API SBE Schema" byteOrder="littleEndian">
  <types>
    ...
    <enum name="TriggerByType" encodingType="uint8">
      <validValue name="UNKNOWN">0</validValue>
      <validValue name="LAST_PRICE">1</validValue>
      <validValue name="MARK_PRICE">2</validValue>
      <validValue name="INDEX_PRICE">3</validValue>
      <validValue name="NON_REPRESENTABLE">254</validValue>
      <sbe:metaAttribute name="sbe:unknownName" value="UNKNOWN"/>
    </enum>
    <enum name="TpSlModeType" encodingType="uint8">
      <validValue name="UNKNOWN">0</validValue>
      <validValue name="FULL">1</validValue>
      <validValue name="PARTIAL">2</validValue>
      <validValue name="NON_REPRESENTABLE">254</validValue>
      <sbe:metaAttribute name="sbe:unknownName" value="UNKNOWN"/>
    </enum>
    ...
    <enum name="OrderFilterType" encodingType="uint8">
      <validValue name="UNKNOWN">0</validValue>
      <validValue name="ORDER">1</validValue>
      <validValue name="TPSL_ORDER">2</validValue>
      <validValue name="STOP_ORDER">3</validValue>
      <validValue name="NON_REPRESENTABLE">254</validValue>
      <sbe:metaAttribute name="sbe:unknownName" value="UNKNOWN"/>
    </enum>
    <enum name="TriggerDirectionType" encodingType="uint8">
      <validValue name="UNKNOWN">0</validValue>
      <validValue name="RISING">1</validValue>
      <validValue name="FALLING">2</validValue>
      <validValue name="NON_REPRESENTABLE">254</validValue>
      <sbe:metaAttribute name="sbe:unknownName" value="UNKNOWN"/>
    </enum>
    ...
    <enum name="SlippageToleranceType" encodingType="uint8">
      <validValue name="UNKNOWN">0</validValue>
      <validValue name="TICK_SIZE">1</validValue>
      <validValue name="PERCENT">2</validValue>
      <validValue name="NON_REPRESENTABLE">254</validValue>
      <sbe:metaAttribute name="sbe:unknownName" value="UNKNOWN"/>
    </enum>
    <enum name="BboSideType" encodingType="uint8">
      <validValue name="UNKNOWN">0</validValue>
      <validValue name="QUEUE">1</validValue>
      <validValue name="COUNTERPARTY">2</validValue>
      <validValue name="NON_REPRESENTABLE">254</validValue>
      <sbe:metaAttribute name="sbe:unknownName" value="UNKNOWN"/>
    </enum>
    <enum name="BoolEnum" encodingType="uint8">
