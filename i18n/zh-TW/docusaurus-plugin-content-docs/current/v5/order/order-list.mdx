...
|startTime |false |integer |開始時間戳 (毫秒) <ul><li>普通現貨暫不支持</li><li>startTime 和 endTime要麼同時傳入，要麼同時不傳</li><li>若不傳，默認查詢過去7天的數據</li><li>startTime 和 endTime每次傳遞的間隔必須在7天內</li></ul>|
