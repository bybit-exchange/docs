...
|symbol |string |交易對名稱 |
|side |string |方向 |
|maxTradeQty |string |最大可用於交易的交易幣種數量<li>若啟用了全倉槓桿且是槓桿幣對, 則返回本身擁有的+最大可借貸數量</li><li>否則, 僅代表實際的餘額</li> |
|maxTradeAmount |string |最大可用於交易的報價幣種金額<li>若啟用了全倉槓桿且是槓桿幣對, 則返回本身擁有的+最大可借貸數量</li><li>否則, 僅代表實際的餘額</li> |
