...
|symbol |string |交易對名稱 |
|side |string |方向 |
|maxTradeQty |string |最大可用於交易的交易幣種數量<ul><li>若啟用了全倉槓桿且是槓桿幣對, 則返回現貨可用+最大可借貸數量</li><li>否則, 僅代表現貨可用</li><li>最多支持4位小數</li></ul>|
|maxTradeAmount |string |最大可用於交易的報價幣種金額<ul><li>若啟用了全倉槓桿且是槓桿幣對, 則返回現貨可用+最大可借貸數量</li><li>否則, 僅代表現貨可用</li><li>最多支持8位小數</li> </ul>|
