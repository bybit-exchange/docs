...
|[positionIdx](../enum#positionidx) |**true** |string |Used to identify positions in different position modes. For `linear` ONLY. Regarding the rule of switching position mode, please refer [here](../position/position-mode#)|
