...
:::tip 升級引導
通過調[查詢賬戶配置](account-info)來確認當前的帳戶型態

* 如果unifiedMarginStatus=1, 則表示當前帳戶是經典帳戶, 您可以調用以下接口升級到UTA Pro. 等到調用升級接口後一段時間, 重新調用[查詢賬戶配置](account-info),
...
* 如果unifiedMarginStatus=3, 則表示當前帳戶是統一交易帳戶 (UTA), 您可以調用以下接口升級到UTA Pro. 等到調用升級接口後一段時間, 重新調用[查詢賬戶配置](account-info),
如果unifiedMarginStatus=4, 則表示帳戶已經成功升級至UTA Pro.
:::
