...
* 如果unifiedMarginStatus=3, 則表示帳戶是[統一帳戶1.0](../acct-mode#統一帳戶10), 您需要前往網站或者app端先升級到[統一帳戶2.0](../acct-mode#統一帳戶20), 或調用此接口升級至[統一帳戶2.0](../acct-mode#統一帳戶20).
調用[查詢賬戶配置](account-info)接口, 如果unifiedMarginStatus=5, 則表示帳戶已經成功升級至[統一帳戶2.0](../acct-mode#統一帳戶20).
