...
|args |false |array&ltobject&gt |參數數組, 僅支持一個訂單 <li>`order.create`: 請參閱[創建訂單請求參數](../../order/create-order#請求參數)</li><li>`order.amend`: 請參閱[修改訂單參數](../../order/amend-order#請求參數)</li><li>`order.cancel`: 請參閱[撤銷訂單參數](../../order/cancel-order#請求參數)</li> |
...
|args |false |array&ltobject&gt |參數數組 <li>`order.create-batch`: 請參閱[批量創建訂單請求參數](../../order/batch-place#請求參數)</li><li>`order.amend-batch`: 請參閱[批量修改訂單參數](../../order/batch-amend#請求參數)</li><li>`order.cancel-batch`: 請參閱[批量撤銷訂單參數](../../order/batch-cancel#請求參數)</li> |
