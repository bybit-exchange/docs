...
* **日本地區用戶**: 主網域名: `api.moneypartners.co.jp`, `api2.moneypartners.co.jp`, `api3.moneypartners.co.jp`, 測試網域名: `api-testnet.moneypartners.co.jp`, `api2-testnet.moneypartners.co.jp`, `api3-testnet.moneypartners.co.jp`
:::
