...
* 🎉 [官方 Rust SDK](https://github.com/bybit-exchange/bybit-rust-api)
* 🎉 [官方 Ruby SDK](https://github.com/bybit-exchange/bybit.ruby.api)
* 🎉 [官方 JavaScript SDK](https://github.com/bybit-exchange/bybit.js.api)
* 🎉 [官方 PHP SDK](https://github.com/bybit-exchange/bybit.php.api)
...
* **土耳其地區用戶**: 主網域名: `https://api.bybit.tr`
...
* **印尼地區用戶**: 主網域名: `https://api.bybit.id`
* **日本地區用戶**: 主網域名: `api.manepa.jp`, 測試網域名: `api-testnet.manepa.jp`
* **巴西地區用戶**: 巴西國際賬號用戶請使用主網域名: `api.bybit.com`, 必須在header裡增加`x-site-id`: **BRA_BTL**
* **阿根廷地區用戶**: 阿根廷國際賬號用戶請使用主網域名: `api.bybit.com`, 必須在header裡增加`x-site-id`: **ARG_BTL**
* **香港地區用戶**: 主網域名: `api.spark-fintech.com`, 測試網域名: `api-testnet.spark-fintech.com`, 必須在header裡增加`x-refer-site-id`: **HKG**
:::
