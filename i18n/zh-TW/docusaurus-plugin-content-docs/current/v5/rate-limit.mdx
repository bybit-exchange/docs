...
|請求方式 |路徑 |頻率 |是否可提頻 |
|:----|:----:|----|----|
|POST |[創建價差委托單](spread/trade/create-order) | 100 req/min| N |
|POST |[修改價差委託單](spread/trade/amend-order) | 100 req/min| N |
|POST |[撤銷價差委託單](spread/trade/cancel-order) | 100 req/min| N |
|POST |[價差-全部撤單](spread/trade/cancel-all) | 100 req/min| N |
