...
|buyLeverage |**true** |string |[`1`, [風險限額](../market/risk-limit#)允許的最大槓桿數] <ul><li>普通帳戶: 單倉模式下, `buyLeverage` 必須等於`sellLeverage`</li><li>統一帳戶: 無論什麼模式, `buyLeverage`必須等於`sellLeverage`</li></ul> |
|sellLeverage |**true** |string |[`1`, [風險限額](../market/risk-limit#)允許的最大槓桿數] <ul><li>普通帳戶: 單倉模式下, `buyLeverage` 必須等於`sellLeverage`</li><li>統一帳戶: 無論什麼模式, `buyLeverage`必須等於`sellLeverage`</li></ul>|
