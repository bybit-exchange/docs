...
:::info
目前支持[統一帳戶2.0](../acct-mode#統一帳戶20) 反向合約移倉
:::
...
|> [category](../enum#category) |**true** |string |產品類型 <ul><li>[統一帳戶2.0](../acct-mode#統一帳戶20): `linear`, `spot`, `option`,`inverse`</li><li> [統一帳戶1.0](../acct-mode#統一帳戶10): `linear`, `spot`, `option`</li></ul>|
