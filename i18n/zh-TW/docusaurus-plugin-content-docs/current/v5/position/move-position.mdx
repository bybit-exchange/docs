...
> **統一帳戶覆蓋範圍: USDT永續 / USDC永續 / USDC交割 / 現貨 / 期權**<br/>
...
* 請注意一旦成交, [查詢成交紀錄](execution#), [查詢平倉盈虧](close-pnl#), 以及私有推送[成交](../websocket/private/execution)會返回execType=`MovePosition`的數據
:::
...
|> [category](../enum#category) |**true** |string |產品類型. `linear`, `spot`, `option` |
...
|> qty |**true** |string |交易數量<ul><li>該數字需要滿足[查詢可交易產品的規格信息](../market/instrument)的qty規則</li></ul>|
