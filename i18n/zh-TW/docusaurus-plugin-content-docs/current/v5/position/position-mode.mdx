...
> **統一帳戶2.0覆蓋範圍: USDT永續**<br/>
> **統一帳戶1.0覆蓋範圍: USDT永續 / 反向交割**<br/>
...
<table class="custom_table">
    ...
    <tr>
        <td>USDC 永續</td><td>僅支持單向持倉</td><td>僅支持單向持倉</td><td>僅支持單向持倉</td>
    </tr>
    <tr>
...
| 參數 | 是否必需 | 類型 | 說明|
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |產品類型 <ul><li> 统一账户2.0: `linear`, USDT 永续</li><li> 统一账户1.0: `linear`, USDT 永续; `inverse`, 反向交割</li><li>经典账户: `linear`, USDT 永续; `inverse`, 反向交割</li></ul> |
