...
| 34022106  | To use this feature, your net liability value must be below %s USD. Otherwise, please repay through spot trading or deposit funds first.  單幣種還款需兌幣負債超過門檻，無法使用單幣種還款|
