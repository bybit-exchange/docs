---
title: 現貨 DMM Listing 指南
sidebar_label: 現貨 DMM Listing 指南
sidebar_position: 1
---
...
- 可交易產品的規格信息: [查詢用户可交易產品的規格信息](/docs/zh-TW/v5/account/instrument)
- REST 創建委託單: [創建委託單](/docs/zh-TW/v5/order/create-order)
- Websocket 下單指南: [Websocket 下單指南](/docs/zh-TW/v5/websocket/trade/guideline)
...
請確認使用符合環境的正確 WS Host. 更多細節請參考 [Websocket 下單指南](/docs/zh-TW/v5/websocket/trade/guideline).
