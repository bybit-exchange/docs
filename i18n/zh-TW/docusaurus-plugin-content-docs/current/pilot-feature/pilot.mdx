...
* 覆蓋範圍: *統一帳戶*
* 詳細內容: *逐步將USDC交割和USDC結算的期權轉為USDT結算, 參考[公告](https://announcements.bybit.com/zh-TW/article/upcoming-changes-to-settlement-currencies-for-bybit-s-options-and-linear-expiry-futures-contracts-blt7a38862820dfad8b/)*
...
* 覆蓋範圍: _普通帳戶, 統一帳戶_
* 詳細內容: _用戶可以通過該[接口](/v5/abandon/upgrade-unified-account)升級至UTA Pro_
...
* 覆蓋範圍: _舊版帶單交易_
* 詳細內容: _Bybit將會從6月24日開始陸續開放uid升級功能, 如果您選擇升級到新的帶單交易, 請注意老版本的Copy Trading V3接口將不可再用, 請直接使用[V5](/v5/order/create-order)接口_
...
* 覆蓋範圍: _普通帳戶升級至統一帳戶_
* 詳細內容: _升級時無需平倉. 更多細節，請查閱[升級接口](v5/abandon/upgrade-unified-account)_
