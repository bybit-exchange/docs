...
|triggerPrice |false |string |Conditional order param. If you expect the price to rise to trigger your conditional order, make sure:<br/> _triggerPrice > max(market price, basePrice)_<br/>Else, _triggerPrice < min(market price, basePrice)_|
