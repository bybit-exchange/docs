...
|[tpTriggerBy](../enum#triggertype) |false |string |The price type to trigger take profit. `LastPrice`,`MarkPrice`|
|[slTriggerBy](../enum#triggertype) |false |string |The price type to trigger stop loss. `LastPrice`,`MarkPrice`|
|[triggerBy](../enum#triggertype) |false |string |Trigger price type. `LastPrice`,`IndexPrice`|
