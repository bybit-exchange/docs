...
|> n | string | Trading fee, it is the latest execution fee for order.<li>After upgraded to the Unified account, you can use `execFee` for each fill in [V5 Execution](/v5/websocket/private/execution) topic</li> |
