...
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <ul><li>[UTA2.0](../acct-mode#uta-20), [UTA1.0](../acct-mode#uta-10): `linear` (USDT Perps, USDC Contract)</li><li>Classic account: `linear` (USDT Perps)</li></ul> |
