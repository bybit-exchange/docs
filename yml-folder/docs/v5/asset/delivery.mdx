...
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <li>[UTA2.0](../acct-mode#uta-20): `inverse`(inverse futures), `linear`(USDC futures), `option`</li><li>[UTA1.0](../acct-mode#uta-10): `linear`(USDC futures), `option`</li> |
