...
of the order.
- A maximum of 20 orders (option), 10 orders (inverse), 10 orders (linear), 10 orders (spot) can be placed per request. The returned data list is divided into two lists.
