...
* Details: _User can upgrade account to UTA Pro via [API](/v5/abandon/upgrade-unified-account)_
...
* Details: _Do not need to close positions when upgrade. For more details. please refer to [upgrade API information](v5/abandon/upgrade-unified-account)_
