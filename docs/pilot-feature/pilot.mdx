...
* Available date: *Testnet - alive, Mainnet - 12 Sep 2024 (gradully released)*
* Cover: *Unified Trading Account*
* Details: *You can upgrade your inverse derivatives account to merge it into Unified Trading*
