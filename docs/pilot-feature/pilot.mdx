...
* Details: _There was no `execType=Funding` in [Get Execution](/v5/position/execution) and websocket `execution` [stream](/v5/websocket/private/execution) update. Now you will it.
