...
Only **Self-generated (RSA) keys is supported, use RSA-SHA256 signing
...
| `BapiTimestamp (30002)` | The current Unix ms timestamp used to derive `expires` (i.e. `expires − 5000`, **not** `expires` itself) |
