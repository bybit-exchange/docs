...
Bybit FIX API provides low-latency access to Spot trading using the **FIX 4.4** protocol over persistent TLS connections.
...
| | REST V5 | FIX API |
|---|---|---|
| Connection | Stateless HTTP | Persistent TLS session |
...
|---|---|---|
| Mainnet (1 Sep) | `fix-oe.bybit.com` | `9000` |
