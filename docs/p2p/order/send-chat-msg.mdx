...
|:----- |:-------|:-----|------ |
|message|**true** |string |chat info ;text:msg;image/pdf/video: url |
|contentType|**true** |string |chat message. For text messages use: `str`; for images use: `pic`; for PDF files use: `pdf`; for video files use: `video`|
