...
## 2025-12-16
- [SBE Level 50 Integration](../v5/sbe/level-50/sbe-level-50) [UPDATE]
...
- [SBE BBO Integration](../v5/sbe/bbo/sbe-bbo) [NEW]
...
- [SBE Level 50 Integration](../v5/sbe/level-50/sbe-level-50) [NEW]
    - Add SBE Level 50 market data endpoint
    - SBE Level 50 for Spot was released on the mainnet at **7:00 AM (UTC+0) on December 2nd**
- [SBE Fast Order Integration](../v5/sbe/fast-order/sbe-fast-order) [NEW]
    - Add SBE Fast Order private data endpoint
