...
## 2026-08-27
### REST API
- [Get Position Info](../v5/position/position) [UPDATE]
    - Add new response field `netDeltaRatio`: Net delta ratio. Option only.

### Websocket API
- [Position](../v5/websocket/private/position) [UPDATE]
    - Add new field `netDeltaRatio`: Net delta ratio. Option only.
