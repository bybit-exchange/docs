...
- [Get Launchpool Project List](../v5/spot-x/launchpool/launchpool-project-list) [NEW]
- [Get Launchpool User Activity Log](../v5/spot-x/launchpool/launchpool-activity-log) [NEW]
- [Get Launchpool Current Staking](../v5/spot-x/launchpool/launchpool-current-staking) [NEW]
- [Get Launchpool User History](../v5/spot-x/launchpool/launchpool-user-history) [NEW]

**Spot-X Puzzle — New endpoints**
- [Get Puzzle Project List](../v5/spot-x/puzzle/puzzle-project-list) [NEW]

**Spot-X Token Splash — New endpoints**
- [Get Token Splash Project List](../v5/spot-x/token-splash/token-splash-project-list) [NEW]
- [Get Token Splash User Activity Params](../v5/spot-x/token-splash/token-splash-user-activity-params) [NEW]
