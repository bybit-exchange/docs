...
## 2026-09-16
### REST API
**RWA Stocks (Market Maker) — New Endpoints**
- [Place Stock Order](../v5/stocks/place-order) [NEW]
- [Cancel Stock Order](../v5/stocks/cancel-order) [NEW]
- [Get Stock Order Detail](../v5/stocks/order-detail) [NEW]
- [Get Convert List](../v5/stocks/convert-list) [NEW]
- [Submit Convert](../v5/stocks/convert-submit) [NEW]
- [Get Convert Detail](../v5/stocks/convert-detail) [NEW]
- [Get Stock Positions](../v5/stocks/positions) [NEW]
- [Get Market Session](../v5/stocks/market-session) [NEW]
- [Get Multiplier List](../v5/stocks/multiplier-list) [NEW]
...
- [Create Order](../v5/order/create-order) [UPDATE]
