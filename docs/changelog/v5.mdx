...
### REST API
- [Get Account Info](../v5/account/account-info) [UPDATE]
    - `smpGroup` is depreciated, please use [Get SMP Group ID](../v5/account/smp-group)
...
## 2023-12-04
### REST API
- [Get Broker Earning](../v5/abandon/earning) [DEPRECIATED]
    - Depreciated, replaced by [Get Exchange Broker Earning](../v5/broker/exchange-earning)
