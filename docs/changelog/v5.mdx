...
## 2026-05-07
### REST API
- [Get Staked Position](../v5/finance/earn/easy-onchain/position.mdx) [UPDATE]
...
## 2026-05-06
### REST API
- [Create Supply Order](../v5/new-crypto-loan/fixed/supply.mdx) [UPDATE]
...
- [Cancel Supply Order](../v5/new-crypto-loan/fixed/cancel-supply.mdx) [UPDATE]
...
## 2026-04-27
### REST API
- [Strategy](../v5/strategy/create-strategy.mdx) [NEW]
