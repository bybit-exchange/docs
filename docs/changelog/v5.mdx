...
- [Get Exchange Entity List](../v5/asset/vasp-list) [NEW]
    - Add a new API for kyc=KOR users to query target exchange info when fill travel rule info

- [Create Internal Transfer](../v5/asset/create-inter-transfer) [UPDATE]
...
## 2024-04-23
### REST API
- [Get Internal Transfer Records](../v5/asset/inter-transfer-list) [UPDATE]
...
## 2024-03-13
### REST API
- [Set Deposit Account](../v5/asset/set-deposit-acct) [UPDATE]
...
## 2024-02-28
### REST API
- [Get Withdrawal Records](../v5/asset/withdraw-record) [UPDATE]
...
- [Get Internal Deposit Records (off-chain)](../v5/asset/internal-deposit-record) [UPDATE]
    - Add a new request param `txID`
...
- [Get Deposit Records (on chain)](../v5/asset/deposit-record) [UPDATE]
...
- [Get Sub Deposit Records (on chain)](../v5/asset/sub-deposit-record) [UPDATE]
    - Add a new response field `depositType`. You can process deposit assets when the deposit has daily deposit limit or abnormal deposit issue.
...
- [Get Sub Deposit Records (on chain)](../v5/asset/sub-deposit-record) [UPDATE]
    - Add a new response field `batchReleaseLimit`, which means the daily deposit limit amount
- [Get Master Deposit Address](../v5/asset/master-deposit-addr) [UPDATE]
    - Add a new response field `batchReleaseLimit`, which means the daily deposit limit amount
- [Get Sub Deposit Address](../v5/asset/sub-deposit-addr) [UPDATE]
    - Add a new response field `batchReleaseLimit`, which means the daily deposit limit amount
