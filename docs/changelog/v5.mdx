...
- [TM-Onchain Appeal](../v5/tm-onchain/appeal-list) [NEW]
    - Launch TM-Onchain compliance appeal OpenAPI for Institution master-sub accounts. REST endpoints: get appeal list / detail, commit appeal.
...
- [Appeal Status Push](../v5/tm-onchain/ws-appeal) [NEW]
    - New private topic `fiat.compliance.appeal`. Push appeal status changes to the Institution master account.
## 2026-09-07
### REST API
