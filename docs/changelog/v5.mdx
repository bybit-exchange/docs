...
## 2025-09-08
### REST API
- [Collateral Repayment](../v5/crypto-loan-fixed/repay-collateral) [NEW]
    - Added fixed collateral repayment endpoint
- [Get Repayment History](../v5/crypto-loan-fixed/repayment-history) [UPDATE]
    - Add a repayType Enum `7：Repayment by Currency` for current repayment records
- [Collateral Repayment](../v5/crypto-loan-flexible/repay-collateral) [NEW]
    - Added flexible collateral repayment endpoint
- [Get Repayment Orders History](../v5/crypto-loan-flexible/repayment-history) [UPDATE]
