...
* [Get Execution](../v5/position/execution) [Delayed to 17 Oct]
    * `execType` has new enumeration value: `MovePosition`, used to indicate the position movement execution (Unified Trading Account)

* [Get Transaction Log](../v5/account/transaction-log) [Delayed to 28 Sep]
    * `type` has new enumeration values: `TRANSFER_IN_INS_LOAN`, `TRANSFER_OUT_INS_LOAN`, `SPOT_REPAYMENT_SELL`, `SPOT_REPAYMENT_BUY` (Unified Trading Account)
