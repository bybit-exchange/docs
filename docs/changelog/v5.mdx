...
- [Advanced-Earn DualAssets APIs and WebSockets](../v5/finance/advanced-earn/product-info) [NEW]
    - We have launched Bybit Advanced-Earn DualAssets. Please see our [Product info](../v5/finance/advanced-earn/product-info) for details.
...
### REST API
- [Get Staked Position](../v5/finance/earn/position) [UPDATE]
    - Add new response field `autoReinvest` to indicate whether auto-reinvest is enabled.
- [Modify Position](../v5/finance/earn/modify-position) [NEW]
    - Add a new endpoint to modify the auto-reinvestment setting for OnChain Fixed positions
- [Get Yield History](../v5/finance/earn/yield-history) [UPDATE]
    - `category` now supports `OnChain`
- [Get APR History](../v5/finance/earn/apr-history) [NEW]
...
## 2026-01-16
### REST API
- [Obtain Max Loan Amount](../v5/finance/crypto-loan/max-loan-amt) [NEW]
...
## 2025-11-27
### REST API
- [Renew Borrow Order](../v5/finance/crypto-loan/fixed/renew) [NEW]
    - Add new endpoint to Renew fixed crypto loan
- [Get Renew Order Info](../v5/finance/crypto-loan/fixed/renew-order) [NEW]
...
- [Get Flexible Loans](../v5/finance/crypto-loan/flexible/unpaid-loan-order) [UPDATE]
...
- Earn API [NEW]
    - [Get Yield History](../v5/finance/earn/yield-history)
    - [Get Hourly Yield History](../v5/finance/earn/hourly-yield)
- Earn API [UPDATE]
    - [Get Stake/Redeem Order History](../v5/finance/earn/order-history)
...
## 2025-09-24
### REST API
- [Create Borrow Order](../v5/finance/crypto-loan/fixed/borrow) [UPDATE]
    - Add a new input parameter `repayType`
- [Get Borrow Contract Info](../v5/finance/crypto-loan/fixed/borrow-contract) [UPDATE]
    - Add a new response field `repayType`
- [Get Borrow Order Info](../v5/finance/crypto-loan/fixed/borrow-order) [UPDATE]
    - Add a new response field `repayType`
- [Get Repayment History](../v5/finance/crypto-loan/fixed/repay-history) [UPDATE]
...
## 2025-09-08
### REST API
- [Collateral Repayment](../v5/finance/crypto-loan/fixed/repay-collateral) [NEW]
    - Add fixed collateral repayment endpoint
- [Get Repayment History](../v5/finance/crypto-loan/fixed/repay-history) [UPDATE]
    - Add a new repayType Enum `7: Repay by Currency` for current repayment records
- [Collateral Repayment](../v5/finance/crypto-loan/flexible/repay-collateral) [NEW]
    - Add flexible collateral repayment endpoint
- [Get Repayment History](../v5/finance/crypto-loan/flexible/repay-orders) [UPDATE]
    - Add a new repayType Enum `7: Repay by Currency` for current repayment records
...
- [Stake / Redeem](../v5/finance/earn/create-order) [UPDATE]
...
## 2025-07-25
### REST API
- [New Crypto Loan](../v5/finance/crypto-loan/loan-coin) [UPDATE]
...
## 2025-07-17
### REST API
- [New Crypto Loan](../v5/finance/crypto-loan/loan-coin) [NEW]
...
## 2025-04-11
### REST API
- [Earn API](https://bybit-exchange.github.io/docs/v5/finance/earn/product-info) [UPDATE]
...
### REST API
- Earn API [NEW]
    - [Get Product Info](../v5/finance/earn/product-info)
    - [Stake / Redeem](../v5/finance/earn/create-order)
    - [Get Stake/Redeem Order History](../v5/finance/earn/order-history)
    - [Get Staked Position](../v5/finance/earn/position)
...
## 2024-10-11
### REST API
- [Crypto Loan](../v5/crypto-loan-legacy/collateral-coin) APIs are released to production [NEW]
