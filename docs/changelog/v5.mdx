...
- [Advanced-Earn DualAssets APIs and WebSockets](../v5/earn/advanced-earn/product-info) [NEW]
    - We have launched Bybit Advanced-Earn DualAssets. Please see our [Product info](../v5/earn/advanced-earn/product-info) for details.
...
## 2025-04-11
### REST API
- [Earn API](https://bybit-exchange.github.io/docs/v5/earn/product-info) [UPDATE]
