...
## 2026-09-08
### REST API
- [TM-Onchain Appeal](../v5/tm-onchain/appeal-list) [NEW]
    - Launch TM-Onchain compliance appeal OpenAPI for Broker master-sub accounts (Global site). REST endpoints: get appeal list / detail, commit appeal.
- [File Upload](../v5/file/file-upload-sign) [NEW]
    - Launch generic File Upload OpenAPI: get upload sign and report upload complete. Used by TM-Onchain appeal and other scenarios.

### Websocket API
- [Appeal Status Push](../v5/tm-onchain/ws-appeal) [NEW]
    - New private topic `fiat.compliance.appeal`. Push appeal status changes to the Broker master account.
## 2026-09-07
### REST API
...
- [Funding Account Transaction History](../v5/asset/fund-history) [UPDATE]
...
### Websocket API
- [WS order entry: Batch Create/Amend/Cancel Order](../v5/websocket/trade/guideline#batch-createamendcancel-order) [UPDATE]
    - category=`option` reduces the batch size to 5

- [SBE order entry: Batch Request V5](../v5/sbe/trade/order-entry#batchcreateorderreqv5-id11) [UPDATE]
    - category=`option` reduces the batch size to 5

## 2026-08-20
### REST API
- [Get Broker Earning](../v5/broker/exchange-broker/exchange-earning) [UPDATE]
...
- [Enum](../v5/enum#typeuta-translog) [UPDATE]
...
## 2026-08-13
### REST API
- [Reinvest](../v5/finance/advanced-earn/liquidity-mining/reinvest) [UPDATE]
...
- [Get Full Depth Orderbook](../v5/market/full-ob) [UPDATE]
    - Support Futures

- [Get Airdrop Products](../v5/finance/earn/hold-to-earn/product) [UPDATE]
...
### Websocket API
- [Full Orderbook](../v5/websocket/public/full-ob) [UPDATE]
    - Support Futures
...
- [Get Available Inventory](../v5/new-crypto-loan/fixed/available-inventory) [NEW]
...
- [Get Available Inventory](../v5/new-crypto-loan/flexible/available-inventory) [NEW]
    - New endpoint to query available lending pool inventory for flexible loan

## 2026-08-06
### REST API
- [Move Position](../v5/position/move-position) [UPDATE]
...
## 2026-08-04
### REST API
- [Self Match Prevention](../v5/smp) [UPDATE]
...
- [Get Coin Delta Amount](../v5/otc/coin-delta-amount) [UPDATE]
    - Add new response field `riskUnitDelta` (risk unit delta value)
- [Create RFQ](../v5/rfq/trade/create-rfq) [UPDATE]
...
- [Create Quote](../v5/rfq/trade/create-quote) [UPDATE]
...
- [Execute Quote](../v5/rfq/trade/execute-quote) [UPDATE]
...
- [Get RFQs](../v5/rfq/trade/rfq-list) [UPDATE]
    - Added response fields: `anonymous` (boolean), `hedge` (array of objects with `category`, `symbol`, `side`, `qty`, `price`)
- [Get Quotes (real-time)](../v5/rfq/trade/quote-realtime) [UPDATE]
    - Added response field `anonymous` (boolean); added `isHedge` (boolean) to each item in `quoteBuyList` and `quoteSellList`
- [Get Quotes](../v5/rfq/trade/quote-list) [UPDATE]
    - Added response field `anonymous` (boolean); added `isHedge` (boolean) to each item in `quoteBuyList` and `quoteSellList`
- [Get RFQ Details](../v5/rfq/trade/rfq-detail-list) [NEW]
...
- [Get Launchpool Project List](../v5/finance/spot-x/launchpool/launchpool-project-list) [NEW]
- [Get Launchpool User Activity Log](../v5/finance/spot-x/launchpool/launchpool-activity-log) [NEW]
- [Get Launchpool Current Staking](../v5/finance/spot-x/launchpool/launchpool-current-staking) [NEW]
- [Get Launchpool User History](../v5/finance/spot-x/launchpool/launchpool-user-history) [NEW]

**Spot-X Puzzle — New endpoints**
- [Get Puzzle Project List](../v5/finance/spot-x/puzzle/puzzle-project-list) [NEW]

**Spot-X Token Splash — New endpoints**
- [Get Token Splash Project List](../v5/finance/spot-x/token-splash/token-splash-project-list) [NEW]
- [Get Token Splash User Activity Params](../v5/finance/spot-x/token-splash/token-splash-user-activity-params) [NEW]

## 2026-07-27
### REST API
- [Get Referral Code](../v5/user/referral-code) [NEW]
...
## 2026-07-21
### Websocket API
- [Fast Order Response](../v5/sbe/private/fast-order) [UPDATE]
    - Option now is available
    - XML version upgrades to v2, added four response fields

## 2026-07-16
### REST API
- [Get Full Depth Orderbook](../v5/market/full-ob) [NEW]
    - You can get up to 10,000 depths per side (Spot)
- [Get Deposit Records (on-chain)](../v5/asset/deposit/deposit-record) [UPDATE]
    - Added new depositStatus values, `7`, `70011`, `70012`, `70013`. For details on each status, please refer to [Deposit Status enum definitions⁠](../v5/enum#depositstatus)
...
### Websocket API
- [Full Orderbook](../v5/websocket/public/full-ob) [NEW]
    - You can subscribe full depths orderbook channel (Spot)

## 2026-07-14
### REST API
- [Get Flexible Available Inventory](../v5/spot-margin-uta/flexible-available-inventory) [NEW]
...
- [Get Fixed-Rate Available Inventory](../v5/spot-margin-uta/fixed-available-inventory) [NEW]
...
## 2026-07-01
### REST API
- [Get Internal Deposit Records](../v5/asset/deposit/internal-deposit-record) [UPDATE]
...
## 2026-07-02
### REST API
- [Alpha Predication Market](../v5/alpha/prediction/engine-status) [NEW]
    - Added new endpoints for Alpha prediction market

### Websocket API
- [SBE Fast Order](../v5/sbe/private/fast-order) [UPDATE]
...
## 2026-06-29
### REST API
- [Get Order List](../v5/finance/earn/byusdt/order) [UPDATE]
    - Add new response fields: `fromAccount`, `toAccount`, `externalEventType`

## 2026-06-23
### REST API
- [Get Coin Delta Amount](../v5/otc/coin-delta-amount) [NEW]
...
## 2026-06-16
### REST API
- [Get Futures Leverage](../v5/position/batch-lvg) [NEW]
    - Add a new endpoint to get futures leverage in one request
- [Get Coupon List](../v5/finance/earn/easy-onchain/coupons) [NEW]
...
- [Execute LP Stake](../v5/alpha/lp/stake) [NEW]
- [Execute LP Redeem](../v5/alpha/lp/redeem) [NEW]
- [Get LP Order List](../v5/alpha/lp/order-list) [NEW]
- [Get LP Pay Token List](../v5/alpha/lp/pay-token-list) [NEW]
- [Get LP Pay Token Price](../v5/alpha/lp/pay-token-price) [NEW]
- [Get LP Pool Info](../v5/alpha/lp/pool-info) [NEW]
- [Get LP Pool List](../v5/alpha/lp/pool-list) [NEW]
- [Get LP Position List](../v5/alpha/lp/position-list) [NEW]
...
-  [Get Open Interest](../v5/market/open-interest) [UPDATE]
...
### REST API
- [Withdraw](../v5/asset/withdraw) [UPDATE]
    - add a new required request param `transactionPurpose` for Bybit Turkey site users

## 2026-04-16
### REST API
- Bybit Card adds new endpoints [NEW]
    - [Query Asset Records](../v5/bybit-card/asset-records) [NEW]
    - [Query Point Balance](../v5/bybit-card/point/balance) [NEW]
    - [Query Point Records](../v5/bybit-card/point/records) [NEW]
    - [Query Tier Info](../v5/bybit-card/point/tier) [NEW]
    - [Query Mall Item List](../v5/bybit-card/point/item-list) [NEW]
    - [Query Cashback Detail](../v5/bybit-card/point/cashback-detail) [NEW]
...
- [Get API Key Information](../v5/user/apikey-info) [UPDATE]
    - Add new response field `FiatBitPay` under `permissions`. The old field `FiatBybitPay` remains available during the transition period
- [Modify Master API Key](../v5/user/modify-master-apikey) [UPDATE]
    - Add new request parameter `FiatBitPay` under `permissions`. The old field `FiatBybitPay` remains available during the transition period
...
- [Advanced-Earn DualAssets APIs and WebSockets](../v5/finance/advanced-earn/dual-asset/product-info) [NEW]
    - We have launched Bybit Advanced-Earn DualAssets. Please see our [Product info](../v5/finance/advanced-earn/dual-asset/product-info) for details.
...
- [RFQ APIs and WebSockets](../v5/rfq/basic-workflow) [NEW]
    - We have launched Bybit RFQ (Request for Quote). Please see our [basic workflow](../v5/rfq/basic-workflow) and the [help centre](https://www.bybit.com/en/help-center/article/Introduction-to-RFQ) for details.
- Earn API [NEW]
...
## 2025-04-11
### REST API
- [Earn API](https://bybit-exchange.github.io/docs/v5/finance/earn/easy-onchain/product-info) [UPDATE]
