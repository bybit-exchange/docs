...
## 2026-06-18
### Enum
- [depositStatus](../v5/enum#depositstatus) [UPDATE]
    - Update `7`: status now indicates rollback is pending system deduction or manual review
    - Add `70011`: Rollback deducted — funds clawed back, deposit will not be credited
    - Add `70012`: Success (3) — no deduction required after review
    - Add `70013`: Success (3) — manually processed, treated as normal successful deposit
