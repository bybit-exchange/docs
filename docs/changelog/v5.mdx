...
## 2024-02-02
### REST API
- [Get Open Interest Limit Info](../v5/position/position-limit-info) [NEW]
    - Add a new endpoint to query account OI data
...
## 2023-09-20
### REST API
- [Get Order Records](../v5/c2c-lend/order-record) [UPDATE]
    - response field `status` added a new enumeration field `11`, which indicates that the cancellation of redeem
- [Cancel Redeem](../v5/c2c-lend/cancel-redeem) [UPDATE]
    - Add a new API endpoint used to cancel the redemption
...
- [Batch Place Order](../v5/order/batch-place) [UPDATE]
    - UTA Pro: support USDT perp, UDSC perp & USDC Futures batch place orders
- [Batch Amend Order](../v5/order/batch-amend) [UPDATE]
    - UTA Pro: support USDT perp, UDSC perp & USDC Futures batch amend orders
- [Batch Cancel Order](../v5/order/batch-cancel) [UPDATE]
    - UTA Pro: support USDT perp, UDSC perp & USDC Futures batch cancel orders
