...
## 2024-07-04
### REST API
- [Get Convert Coin List](../v5/asset/convert/convert-coin-list) [UPDATE]

- [Request a Quote ](../v5/asset/convert/apply-quote) [UPDATE]

- [Confirm a Quote ](../v5/asset/convert/confirm-quote) [UPDATE]

- [Get Single Quote Result ](../v5/asset/convert/get-convert-result) [UPDATE]

- [Get Quote history ](../v5/asset/convert/get-convert-history) [UPDATE]
...
- [Get Internal Deposit Records (off-chain)](../v5/asset/transfer/internal-deposit-record) [UPDATE]
    - Add a new request param `txID`
...
- [Get Internal Deposit Records (across Bybit)](../v5/asset/transfer/internal-deposit-record) [NEW]
