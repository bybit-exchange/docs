...
- [Get Repayment History](../v5/new-crypto-loan/fixed/repay-history) [UPDATE]
    - Add a repayType Enum `7：Repayment by Currency` for current repayment records
...
- [Get Repayment Orders History](../v5/new-crypto-loan/flexible/repay-orders) [UPDATE]
    - Add a new repayType Enum `7：Repayment by Currency` for current repayment records
