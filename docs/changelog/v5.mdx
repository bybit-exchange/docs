...
- [Rate Limit](../v5/rate-limit) [UPDATE]
    - [Set api rate limit](../v5/rate-limit#set-api-rate-limit) Change the input parameter `limit` to `rate`, and change the returned field `limit` to `rate`.
    - [Query api rate limit](../v5/rate-limit#query-api-rate-limit) Change returned field `limit` to `rate`.
- [Rate Limit](../v5/rate-limit) [NEW]
    - Add endpoints to [query ins level api rate limit uages and cap](../v5/rate-limit#query-api-rate-limit-usage-and-cap) and [query all uid level api rate limit](../v5/rate-limit#query-all-api-rate-limit)
