...
## 2026-09-22
### REST API
- [Batch Request Export Reports](../v3/tax/batch-create.mdx) [NEW]
...
- [Get Batch Export Report Status](../v3/tax/batch-query.mdx) [NEW]
    - Add `GET /v5/fht/compliance/tax/private/batch_query` to query each task's status and download URL by `batchId`.
- [Get Option Base Coins](../v5/market/option-base-coins) [NEW]
...
- [Get Delay Liquidation Status](../v5/otc/delay-liq-status) [NEW]
