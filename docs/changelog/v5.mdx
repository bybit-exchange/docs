...
## 2025-04-17
### REST API
- [Request a Quote](../v5/asset/exchange/quote-apply) [UPDATE]
...
- [Cancel All Orders](../v5/order/cancel-all) [UPDATE]
    - Option orders can be cancelled by specifying `settleCoin`, and choose cancell all USDT or USDC Option orders
