...
- [Get Fee Group Structure](../v5/market/fee-group-info) [NEW]
    - Add group fee structure and information endpoint
...
- [Get ADL Alert](../v5/market/adl-alert) [NEW]
    - Add grouped insurance pool ADL alert and information endpoint
...
- [Get Index Price Components](../v5/market/index-components) [NEW]
    - Add new endpoint to query index price components

## 2025-09-18
### REST API
- [Get RPI Orderbook](../v5/market/rpi-orderbook) [NEW]
    - Add new endpoint to query RPI orderbook
