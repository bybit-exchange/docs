...
- [Get Wallet Balance](../v5/account/wallet-balance) [Update]
    - Add a new new field `spotBorrow` to indicate Borrowed trade amount by spot margin trade
...
### WebSocket API
- [Wallet](../v5/account/wallet-balance) [Update]
    - Add a new new field `spotBorrow` to indicate Borrowed trade amount by spot margin trade
...
- Earn API [NEW]
    - [Get Yield History](../v5/earn/yield-history)
    - [Get Hourly Yield History](../v5/earn/hourly-yield)
- Earn API [UPDATE]
...
- [Get Instruments Info](../v5/market/instrument) [UPDATE]
    - category=`spot` adds a new response fields `maxLimitOrderQty`, `maxMarketOrderQty`, will becomes effective on 16th Oct, refer to [Changes to maximum order size for limit and market orders](https://announcements.bybit.com/article/changes-to-maximum-order-size-for-limit-and-market-orders-blt6ac479804a794c46/) to get more details
