...
## 2023-06-23
### REST API
* Bybit will release a fully new copy trading on **23rd June 2023**. It is released gradually by end digit of uid. You can select to upgrade to new copy trading when you are applicable. Once upgraded, please note below points:
