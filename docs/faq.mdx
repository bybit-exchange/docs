...
a. When request to api.bybit.com or stream.bybit.com, make sure the api key is created from [Prodution](www.bybit.com)
...
```
---
b. When request to api-demo.bybit.com or stream-demo.bybit.com, make sure the api key is created from [Production](www.bybit.com) - **demo trading**
...
```
---
c. When request to api-testnet.bybit.com or stream-testnet.bybit.com, make sure the api key is created from [Testnet](testnet.bybit.com)
![test](/img/test.png)
```python
# pybit example
session = HTTP(
