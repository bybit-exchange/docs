---
title: Get Broker Earning (depreciated)
sidebar_label: Get Broker Earning (depreciated)
sidebar_position: 1
---
:::warning
This endpoint has been depreciated, please move to new [Get Exchange Broker Earning](exchange-earning#)
:::
