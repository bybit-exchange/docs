---
title: Query Issued Voucher
sidebar_label: Query Issued Voucher
sidebar_position: 3
---
...
|withUsedAmount |false |boolean |Whether to return the amount used by the user <li>`true`</li><li>`false` (default)</li>|
