...
delivery, spot and options are all traded within the "unified trading"
...
<table>
    ...
    <tr>
        <td rowSpan="5" align="center">Position</td><td><a href="position#">Get Position Info</a></td><td>1. Passing multiple symbols is not supported<br/>2. In the response, there are changes in the use of "tradeMode", "autoAddMargin", "liqPrice", "bustPrice" fields</td><td>1. Supports passing multiple symbols</td>
    </tr>
    <tr>
