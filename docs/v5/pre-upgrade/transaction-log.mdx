...
sidebar_position: 4
---
Query transaction logs occurred in USDC Derivatives wallet before the account is upgraded to Unified account.

You can get USDC Perpetual, Options records.
