...
Query user's closed profit and loss records before you upgrade the account to Unified account. The results are sorted by `createdTime` in descending order.
