...
|> tradeMode | integer |Trade mode <ul><li>Classic & [UTA1.0](../../acct-mode#uta-10)(inverse): `0`: cross-margin, `1`: isolated margin</li><li>[UTA2.0](../../acct-mode#uta-20), [UTA1.0](../../acct-mode#uta-10)(execpt inverse): depreciated, always `0`, check [Get Account Info](/v5/account/account-info) to know the margin mode</li></ul>|
