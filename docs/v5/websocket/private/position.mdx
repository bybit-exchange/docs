...
|> positionIMByMp | string  |Initial margin<li>Classic & [UTA1.0](../../acct-mode#uta-10)(inverse): ignore this field</li><li>UTA portfolio margin mode, it returns ""</li> |
...
|> positionMMByMp | string  |Maintenance margin<li>Classic & [UTA1.0](../../acct-mode#uta-10)(inverse): ignore this field</li><li>UTA portfolio margin mode, it returns ""</li>|
