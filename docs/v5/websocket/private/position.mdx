...
|data |array |Object |
|> category |string |Product type <ul><li>Unified account: does not have this field</li><li>Normal account: `linear`, `inverse`.</li></ul>|
...
|> positionBalance |string |Position margin. _Unified account does not have this field_ |
|> autoAddMargin |integer |Whether to add margin automatically. `0`: false, `1`: true. _Unified account does not have this field_ |
