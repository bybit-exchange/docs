...
|>> availableToWithdraw |string |Available amount to withdraw of coin <br/>**Note:** this field is deprecated for accountType=UNIFIED, you can use [Get Transferable Amount (Unified)](unified-trans-amnt#) instead|
