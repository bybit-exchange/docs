...
|> parentOrderLinkId |string |Indicates the linked parent order for attached take-profit and stop-loss orders. Supported for futures and options.<li>[Amending](../../order/amend-order#) take-profit or stop-loss orders does not change the parentOrderLinkId</li><li>**Futures**: using [set trading stop](../../position/trading-stop#) to update attached TP/SL from the original order does not change the parentOrderLinkId.<br/>**Options**: using [set trading stop](../../position/trading-stop#) to update attached TP/SL from the original order will change the parentOrderLinkId.<br/>**Futures & Options**: if TP/SL is set via [set trading stop](../../position/trading-stop#)for a position that originally has no attached TP/SL, the parentOrderLinkId is meaningless.</li> |
