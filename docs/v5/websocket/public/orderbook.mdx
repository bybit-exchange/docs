...
### Ongoing change
Between March 20 and March 27, 2025, the Spot and Futures order book Level 1 will support only snapshot messages. During the deployment period, some pairs will include both 
snapshot and delta updates, while others will support snapshot-only updates.
