...
|> u |integer |Update ID. Is a sequence. Occasionally, you'll receive "u"=1, which is a snapshot data due to the restart of the service. So please overwrite your local orderbook <li>Please note Option starts from 0, and we will make it consistent with others later</li>  |
