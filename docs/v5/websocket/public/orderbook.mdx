...
:::note reminder
* Spot & Futures Level 1: the "ts" field appears **before** the "type" field in the JSON message, e.g., `{"toptic": "orderbook.1.BTCUSDT", "ts": "1772694601512", "type": "snapshot", ...}`
* Spot & Futures other levels: the "ts" field appears **after** the "type" field in the JSON message, e.g., `{"toptic": "orderbook.50.BTCUSDT", "type": "delta", "ts": "1772694601512", ...}`
:::
