...
<TabItem value="future" label="Linear/Inverse" default>
    <table border="0.8">
        ...
        <tr>
            <td>> deliveryTime</td><td>datetime</td><td>Delivery date time (UTC+0). <i>Unique field for inverse futures</i> </td>
        </tr>
        <tr>
            <td>> basisRate</td><td>string</td><td>Basis rate. <i>Unique field for inverse futures</i></td>
        </tr>
        <tr>
            <td>> deliveryFeeRate</td><td>string</td><td>Delivery fee rate. <i>Unique field for inverse futures</i></td>
        </tr>
        <tr>
            <td>> predictedDeliveryPrice</td><td>string</td><td>Predicated delivery price. <i>Unique field for inverse futures</i></td>
        </tr>
    </table>
</TabItem>
...
<table border="0.8">
    ...
    <tr>
        <td>> usdIndexPrice</td><td>string</td><td>USD index price. It can be empty </td>
    </tr>
</table>
</TabItem>
</Tabs>
