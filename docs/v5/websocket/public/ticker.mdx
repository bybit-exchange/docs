...
<TabItem value="linear" label="Linear/Inverse" default>
    <table border="0.8">
        ...
        <tr>
            <td>> fundingIntervalHour</td><td>string</td><td>Funding interval hour<li>This value currently only supports whole hours</li><li>Only for Perpetual,For Futures,this field will not return</li></td>
        </tr>
        <tr>
            <td>> fundingCap</td><td>string</td><td>Funding rate upper and lower limits<li>Only for Perpetual,For Futures,this field will not return</li></td>
        </tr>
        <tr>
            <td>> basisRateYear</td><td>string</td><td>Annual basis rate<li>Only for Futures,For Perpetual,this field will not return</li></td>
        </tr>
    </table>
</TabItem>
