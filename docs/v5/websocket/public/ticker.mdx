...
* Spot & Option tickers message has **snapshot** ONLY
:::
...
<table border="0.8">
    ...
    <tr>
        <td>> bidPrice</td><td>string</td><td>Bid 1 price </td>
    </tr>
    <tr>
        <td>> bidSize</td><td>string</td><td>Bid 1 size </td>
    </tr>
    <tr>
        <td>> bidIv</td><td>string</td><td>Bid 1 iv </td>
    </tr>
    <tr>
        <td>> askPrice</td><td>string</td><td>Ask 1 price </td>
    </tr>
    <tr>
        <td>> askSize</td><td>string</td><td>Ask 1 size </td>
    </tr>
    <tr>
        <td>> askIv</td><td>string</td><td>Ask 1 iv </td>
    </tr>
    <tr>
        <td>> lastPrice</td><td>string</td><td>Last price </td>
    </tr>
