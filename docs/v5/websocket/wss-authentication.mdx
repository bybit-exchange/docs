...
RFQ: `wss://stream.bybit.com/v5/public/rfq`<br/>
...
RFQ: `wss://stream-testnet.bybit.com/v5/public/rfq`<br/>
...
:::info
* If your account is registered from www.bybit.tr, please use `stream.bybit.tr` for mainnet access
* If your account is registered from www.bybit.id, please use `stream.bybit.id` for mainnet access
...
* If your account is registered from www.manepa.jp, please use `stream.manepa.jp` for mainnet access
...
* If your account is registered from www.spark-fintech.com, please use `stream.spark-fintech.com`, and add `x-refer-site-id`: **HKG** in the request header for mainnet access for mainnet access
:::
