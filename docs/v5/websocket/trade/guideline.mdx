...
|args |false |array&ltobject&gt |Args array <li>`order.create-batch`: refer to [Batch Place Order request](../../order/batch-place#request-parameters)</li><li>`order.amend-batch`: refer to [Batch Amend Order request](../../order/batch-amend#request-parameters)</li><li>`order.cancel-batch`: refer to [Batch Cancel Order request](../../order/batch-cancel#request-parameters)</li> |
