...
The underlying of Pyth is West Texas Intermediate (WTI) crude oil; Pyth price data for the contract can be referenced at [Pyth Data Explorer](https://pythdata.app/explore/Commodities.WTIM6%2FUSD).

On weekends when Pyth markets are closed, Friday's closing price is used as the index price component.
:::
