...
|> complianceStatus|integer|Internal transfer compliance collection status. **Only applicable to Bybit Turkey site users** <ul><li>0: No collection required</li><li>1: Pending collection</li><li>2: Collected</li><li>3: Completed</li></ul>|
