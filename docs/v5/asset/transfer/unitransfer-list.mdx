...
|fromMemberId |false |string |From UID|
|toMemberId |false |string |To UID|
...
|> withdrawReqId |string |Deduction req ID (internal use), can be used to map the `id` in [Get Transaction Log](../../account/transaction-log) |
|> depositReqId |string |Credit req ID (internal use), can be used to map the `id` in [Get Transaction Log](../../account/transaction-log) |
...
```json
{
    ...
    "result": {
        "list": [
            {
                "transferId": "30effa41-501f-4020-acd8-e57d9f81e23d",
                "coin": "USDC",
                "amount": "1000",
                ...
                "fromMemberId": "533285",
                "toMemberId": "592324",
                "withdrawReqId": "30effa41-501f-4020-acd8-e57d9f81e23d",
                "depositReqId": "c1fb8ebe-e309-472c-8485-c1b78f2048bb"
            }
        ],
