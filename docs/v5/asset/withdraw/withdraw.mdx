...
|> beneficiaryAddressBuilding |false |string |Beneficiary building address <li><b>Required</b> param for ID users only</li>|
|> beneficiaryAddressStreet |false |string |Beneficiary street address <li><b>Required</b> param for ID users only</li>|
|> beneficiaryAddressPostalCode |false |string |Beneficiary address post code <li><b>Required</b> param for ID users only</li>|
|> beneficiaryDateOfBirth |false |string |Beneficiary date of birth <li><b>Required</b> param for ID users only</li>|
|> beneficiaryPlaceOfBirth |false |string |Beneficiary birth place <li><b>Required</b> param for ID users onl</li>|
