...
|> coinType |string |`crypto`, `fiat`|
|> balance |string |Coin balance <li>Only when side=0, it checks balance, otherwise, it is ""</li> |
        ...
        "coins": [
            {
                "coin": "CHF",
                "fullName": "CHF",
                "icon": "https://t1.bycsi.com/common-static/wove/fiat-admin/2023-5-5/Tyoe=CHF.svg",
                "iconNight": "",
                "accuracyLength": 2,
                "coinType": "fiat",
                "balance": "",
                "uBalance": "",
                "timePeriod": 0,
                "singleFromMinLimit": "0",
                "singleFromMaxLimit": "0",
                "singleToMinLimit": "0",
                "singleToMaxLimit": "0",
                "dailyFromMinLimit": "0",
                "dailyFromMaxLimit": "0",
