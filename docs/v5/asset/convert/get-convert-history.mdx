...
|:----- |:-------|:-----|------ |
|[accountType](/v5/enum#convertaccounttype) |false |string |Wallet type <br/><code>eb_convert_funding</code>: funding wallet convert records via API<br/><code>eb_convert_uta</code>: uta wallet convert records via API<br/><code>funding</code>: normal crypto convert via web/app<br/><code>funding_fiat</code>: fiat crypto convert via web/app<br/><code>funding_fbtc_convert</code>: FBTC to BTC convert via web/app<br/><code>funding_block_trade</code>: block trade convert via web/app<li>Supports passing multiple types, separated by comma e.g., <code>eb_convert_funding,eb_convert_uta</code></li><li>Return all wallet types data if not passed</li>|
