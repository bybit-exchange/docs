...
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <li>UTA2.0: `inverse`(inverse futures), `linear`(USDC futures), `option`</li><li>UTA1.0: `linear`(USDC futures), `option`</li> |
