---
title: Asset History (Funding Account)
sidebar_label: Asset History (Funding Account)
---

Return transaction log in Funding Account under a specific account type. This endpoint supports filtering by transaction type and time range.
...
|limit |false |string |Limit for data size per page. Default: `10` |
