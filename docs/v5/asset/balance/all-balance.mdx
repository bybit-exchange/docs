...
|coin |false |string |Coin name, uppercase only <ul><li>Query all coins if not passed</li><li>Can query multiple coins, separated by comma. `USDT,USDC,ETH`</li></ul>**Note:** this field will become the **mandatory** field for accountType=`UNIFIED`, and supports up to 10 coins each request since 9 JAN 2025|
