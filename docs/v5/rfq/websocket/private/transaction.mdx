...
| > quoteSide       | string              | Return of completed inquiry, executed quotation direction, `buy` or `sell`                                                                |
