...
|>> quoteDestCode |string |The unique identification code of the quotation party, which is not visible when anonymous is set to `true` during quotation |
