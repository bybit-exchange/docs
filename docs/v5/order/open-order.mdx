...
|> cumExecFee |string |Deprecated. Cumulative executed trading fee. _Classic `spot` is not supported_  |
...
|> cumFeeDetail |json |Cumulative trading fee details instead of `cumExecFee`
