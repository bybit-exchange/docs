...
|startTime |false |integer |The start timestamp (ms) <ul><li>startTime and endTime are not passed, return 7 days by default;<li>Only startTime is passed, return range between startTime and startTime+7 days</li><li>Only endTime is passed, return range between endTime-7 days and endTime<br/>If both are passed, the rule is endTime - startTime <= 7 days</li></ul>|
...
|> [createType](../enum#createtype) |string |Order create type <ul><li>Spot, Option do not have this key</li></ul> |
