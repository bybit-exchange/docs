...
|baseCoin |false |string |Base coin, uppercase only. _Unified account - inverse and Classic account do not support this param_ |
...
|> [createType](../enum#createtype) |string |Order create type <li>UTA: Only for category=linear</li><li>Classic & UTA(inverse): always `""`</li><li>Spot, Option do not have this key</li> |
