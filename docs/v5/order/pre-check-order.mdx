...
:::info
1. This endpoint supports orders with category = `inverse`,`linear`,`option` for UTA2.0 account, and supports orders with category =`linear`,`option` for UTA1.0 account <br/>
