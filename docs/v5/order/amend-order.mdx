...
|takeProfit |false |string |Take profit price after modification. Do not pass it if you do not want to modify the take profit. To cancel, pass `0` |
|stopLoss |false |string |Stop loss price after modification. Do not pass it if you do not want to modify the stop loss. To cancel, pass `0` |
