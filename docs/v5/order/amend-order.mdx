...
|[tpTriggerBy](../enum#triggerby) |false |string |The price type to trigger take profit. `LastPrice`,`MarkPrice`,`IndexPrice`|
|[slTriggerBy](../enum#triggerby) |false |string |The price type to trigger stop loss. `LastPrice`,`MarkPrice`, `IndexPrice` |
