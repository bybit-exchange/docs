...
## Applicable
Effective for **Inverse Perp / Inverse Futures / USDT Perp / USDC Perp / USDC Futures / Spot / options** ([UTA2.0](../acct-mode#uta-20))<br/>
Effective for **USDT Perp / USDC Perp / USDC Futures / Spot / options**  ([UTA1.0](../acct-mode#uta-10))
:::
