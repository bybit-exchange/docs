...
- `200` response is only an ACK — use [Get Order List](../order-list) to check redemption status
...
|:----- |:-----|----- |
|orderNo |string |Order number for this redemption operation. Use this to track status via [Get Order List](../order-list)|
