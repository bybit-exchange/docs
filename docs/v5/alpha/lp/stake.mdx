...
:::info
- Must call [Get Pay Token List](../trade/pay-token-list) to verify available balance before staking
...
- `200` response is only an ACK — use [Get Order List](../trade/order-list) to check final position status
