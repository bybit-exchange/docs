...
<table border="0.8">
    ...
    <tr>
        <td>/v5/order/amend</td><td colSpan="2" align="center">10/s</td><td align="center">-</td><td align="center">Y</td>
    </tr>
    <tr>
...
<table border="0.8">
    ...
    <tr>
        <td>/v5/order/amend</td><td align="center">10/s</td><td align="center">10/s</td><td align="center">10/s</td><td align="center">-</td><td align="center">Y</td>
    </tr>
    <tr>
    ...
    <tr>
        <td rowSpan="3">GET</td><td>/v5/order/realtime</td><td align="center">10/s</td><td colSpan="3" align="center">50/s</td><td align="center">N</td>
    </tr>
    <tr>
...
<table border="0.8">
    ...
    <tr>
        <td rowSpan="3">GET</td><td>/v5/position/list</td><td colSpan="2" align="center">10/s</td><td align="center">-</td><td align="center">N</td>
    </tr>
    <tr>
...
The batch order endpoint, which includes operations for creating, amending, and canceling, has its own rate limit and does not share it with single requests

#### When category = linear
