...
<table border="0.8">
    ...
    <tr>
        <td rowSpan="7">POST</td><td>/v5/order/create</td><td colSpan="2" align="center">10/s</td><td>20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/amend</td><td colSpan="2" align="center">10/s</td><td>-</td><td align="center">Y</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/v5/order/create-batch</td><td align="center">-</td><td>-</td><td align="center">-</td><td align="center">-</td>
    </tr>
    <tr>
        <td>/v5/order/amend-batch</td><td align="center">-</td><td>-</td><td align="center">-</td><td align="center">-</td>
    </tr>
    <tr>
        <td>/v5/order/cancel-batch</td><td align="center">-</td><td>-</td><td align="center">-</td><td align="center">-</td>
    </tr>
    <tr>
        <td rowSpan="2">GET</td><td>/v5/order/realtime</td><td colSpan="2" align="center">10/s</td><td>20/s</td><td align="center">N</td>
    </tr>
    <tr>
...
<table border="0.8">
    ...
    <tr>
        <td>/v5/order/cancel-all</td><td colSpan="2" align="center">10/s</td><td align="center">1/s</td><td>20/s</td><td align="center">N</td>
    </tr>
    <tr>
...
<TabItem value="uta-pro" label="UTA Pro" default>
<span class="blocky_table">
<table border="0.8">
    <tr>
    ...
    <tr>
        <td rowSpan="7">POST</td><td>/v5/order/create</td><td align="center">10/s</td><td align="center">10/s</td><td align="center">10/s</td><td>20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/amend</td><td align="center">10/s</td><td align="center">10/s</td><td align="center">10/s</td><td>-</td><td align="center">Y</td>
    </tr>
    <tr>
...
<table border="0.8">
    ...
    <tr>
        <td rowSpan="3">GET</td><td>/v5/position/list</td><td colSpan="2" align="center">10/s</td><td>-</td><td align="center">N</td>
    </tr>
    <tr>
        <td>/v5/execution/list</td><td colSpan="2" align="center">10/s</td><td>20/s</td><td align="center">N</td>
    </tr>
    <tr>
        <td>/v5/position/closed-pnl</td><td colSpan="2" align="center">10/s</td><td>-</td><td align="center">N</td>
    </tr>
</table>
</span>
</TabItem>
...
<table border="0.8">
    ...
    <tr>
        <td rowSpan="3">GET</td><td>/v5/position/list</td><td align="center">10/s</td><td colSpan="2" align="center">50/s</td><td align="center">-</td><td align="center">N</td>
    </tr>
    <tr>
