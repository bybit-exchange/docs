...
|Method |Path |Limit |Upgradable|
|:----|:----:|----|----|
|POST |[Create Spread Order](spread/trade/create-order) | 100 req/min| N |
|POST |[Amend Spread Order](spread/trade/amend-order) | 100 req/min| N |
|POST |[Cancel Spread Order](spread/trade/cancel-order) | 100 req/min| N |
|POST |[Cancel All Spread Orders](spread/trade/cancel-all) | 100 req/min| N |
