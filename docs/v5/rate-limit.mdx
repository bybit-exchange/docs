...
<table border="0.8">
    ...
    <tr>
        <td rowSpan="13">GET</td><td>/v5/asset/transfer/query-asset-info</td><td>60 req/s</td><td>N</td>
    </tr>
    <tr>
        <td>/v5/asset/transfer/query-transfer-coin-list</td><td>60 req/s</td><td>N</td>
    </tr>
    <tr>
        <td>/v5/asset/transfer/query-inter-transfer-list</td><td>60 req/s</td><td>N</td>
    </tr>
    <tr>
        <td>/v5/asset/transfer/query-sub-member-list</td><td>60 req/s</td><td>N</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/v5/asset/deposit/query-record</td><td>100 req/s</td><td>N</td>
    </tr>
    <tr>
        <td>/v5/asset/deposit/query-sub-member-record</td><td>300 req/s</td><td>N</td>
    </tr>
    <tr>
        <td>/v5/asset/deposit/query-address</td><td>300 req/s</td><td>N</td>
    </tr>
    <tr>
        <td>/v5/asset/deposit/query-sub-member-address</td><td>300 req/s</td><td>N</td>
    </tr>
    <tr>
        <td>/v5/asset/withdraw/query-record</td><td>300 req/s</td><td>N</td>
    </tr>
    <tr>
        <td>/v5/asset/coin/query-info</td><td>2 req/s</td><td>N</td>
    </tr>
    <tr>
        <td>/v5/asset/exchange/order-record</td><td>600 req/s</td><td>N</td>
    </tr>
    <tr>
        <td rowSpan="5">POST</td><td>/v5/asset/transfer/inter-transfer</td><td>20 req/s</td><td>N</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/v5/asset/withdraw/cancel</td><td>60 req/s</td><td>N</td>
    </tr>
</table>
</span>
