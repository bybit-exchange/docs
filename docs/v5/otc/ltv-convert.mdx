...
:::note important
In cases where an institutional user makes frequent transfers or experiences frequent changes in funds, LTV calculations may become inaccurate, and this endpoint will return retCode = 100016, retMsg = "The account balance is changing frequently. Please try again later."
:::
