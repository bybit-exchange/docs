...
|> ltv | string	| Risk rate <li>ltv is calculated in real time</li><li>If you have an INS loan, it is highly recommended to query this data every second. Liquidation occurs when it reachs 0.9 (90%)</li>. When `liqStatus` != 0, empty string is returned. |
