...
---
Bybit's v5 Open API allows users to trade all of Bybit's products with a single API suite.
Bybit's v5 Open API allows users to trade on all of Bybit products through a single API suite.

## Scope
| Account Mode | v5 Open API | Comments|
|:----- |:-------|------ |
|Normal account |true |Can trade spot, futures, options |
|Unified margin account |true |Can trade linear contracts, options; cannot trade spot, inverse contracts|
