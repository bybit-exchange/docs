...
* _Classic account_
    - Funding wallet
    - Derivatives wallet: trade USDT Perpetual, Inverse Perpetual and Inverse Futures
    - Spot wallet: trade Spot
* _Unified trading account(1.0)_
    - Funding wallet
    - Inverse derivatives wallet: trade Inverse Perpetual and Inverse Futures
    - Unified wallet: trade USDT Perpetual, USDC Perpetual, USDC Futures, Spot and Options
* _Unified trading account(2.0)_
    - Funding wallet
    - Unified wallet: trade USDT Perpetual, USDC Perpetual, USDC Futures, Inverse Perpetual, Inverse Futures, Spot and Options
