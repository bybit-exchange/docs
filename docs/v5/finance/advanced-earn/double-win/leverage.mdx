...
* This endpoint is **only for RFQ products** (`isRfqProduct=true`). For fixed price range products, use [Get Product Quote](./product-quote) or subscribe to the WebSocket topic [`earn.doublewin.offers`](./ws-offers).
:::
