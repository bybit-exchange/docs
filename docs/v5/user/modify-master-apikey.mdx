...
|> FiatP2P |false |array |Permission of P2P|
|> FiatBybitPay |false |array |Permission of Bybit pay|
|> FiatConvertBroker |false |array |Permission of fiat convert|
|> NFT |false |array |**Deprecated**, always `[]`|
