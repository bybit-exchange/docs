...
|>> availableToWithdraw |string |Available amount to withdrawable/transferable of coin <br/>**Note:** this field will be deprecated for accountType=UNIFIED since 9 JAN 2025, you can use [Get Transferable Amount (Unified)](unified-trans-amnt#) instead|
