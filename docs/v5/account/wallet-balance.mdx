...
|:----- |:-------|:-----|------ |
|[accountType](../enum#accounttype) |**true** |string |Account type <ul><li>Unified account: `UNIFIED` (trade spot/linear/options), `CONTRACT`(trade inverse)</li><li>Normal account: `CONTRACT`</li></ul> |
...
|>> bonus |string |Bonus. _This is a unique field for UNIFIED wallet_ |
