...
|:----- |:-------|:-----|------ |
|[accountType](../enum#accounttype) |**true** |string |Account type <ul><li>UTA2.0: `UNIFIED`</li><li>UTA1.0: `UNIFIED`, `CONTRACT`(inverse derivatives wallet)</li><li>Classic account: `CONTRACT`, `SPOT`</li></ul>To get Funding wallet balance, please go to this [endpoint](../asset/balance/all-balance) |
