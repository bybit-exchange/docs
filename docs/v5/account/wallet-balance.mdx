...
|>> availableToWithdraw |string |Available amount to withdrawable/transferable of coin <br/>**Note:** this field is deprecated for accountType=UNIFIED, you can use [Get Transferable Amount (Unified)](unified-trans-amnt#) instead|
