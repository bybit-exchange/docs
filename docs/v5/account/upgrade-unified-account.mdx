...
2. Upgrading from UTA PUBLIC to UTA PRO is prohibited daily between **07:55 and 08:05 UTC+0**<br/><br/>
3. Please ensure: there is no open orders when upgrade from [UTA2.0](../acct-mode#uta-20) to [UTA2.0](../acct-mode#uta-20) Pro<br/><br/>
