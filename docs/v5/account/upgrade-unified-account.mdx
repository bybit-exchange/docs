...
sidebar_position: 2
---
In the mainnet, you still can use this API to upgrade your classic account to Unified account.

Below part now is appliable to **Testnet**, you can upgrade the account to UTA2.0
...
* if unifiedMarginStatus=4, then it is UTA1.0 Pro, you can call below upgrade endpoint to UTA2.0 Pro. Check
[Get Account Info](account-info) after a while and if unifiedMarginStatus=6, then it is successfully upgraded to UTA2.0 Pro.

* if unifiedMarginStatus=5, then it is UTA2.0, you can call below upgrade endpoint to UTA2.0 Pro. Check
[Get Account Info](account-info) after a while and if unifiedMarginStatus=6, then it is successfully upgraded to UTA2.0 Pro.
:::
...
2. Please ensure: there is no open orders when upgrade from UTA2.0 to UTA2.0 Pro<br/><br/>
