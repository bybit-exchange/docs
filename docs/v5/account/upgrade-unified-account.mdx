...
* if unifiedMarginStatus=3, then it is [UTA1.0](../acct-mode#uta-10), and you have to head to the website to click "upgrade" to upgrade to [UTA2.0](../acct-mode#uta-20) first,
or you can call the below endpoint to upgrade to [UTA2.0](../acct-mode#uta-20). Check [Get Account Info](account-info) after a while and if unifiedMarginStatus=5,
then the account has successfully upgraded to [UTA2.0](../acct-mode#uta-20).

* if unifiedMarginStatus=4, then it is [UTA1.0](../acct-mode#uta-10) Pro, and you can call the below endpoint to upgrade to [UTA2.0](../acct-mode#uta-20) Pro. Check
[Get Account Info](account-info) after a while and if unifiedMarginStatus=6, then the account has successfully upgraded to [UTA2.0](../acct-mode#uta-20) Pro.
