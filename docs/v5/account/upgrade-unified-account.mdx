...
or you can call below upgrade endpoint to [UTA2.0](../acct-mode#uta-20). Check [Get Account Info](account-info) after a while and if unifiedMarginStatus=5,
then it is successfully upgraded to [UTA2.0](../acct-mode#uta-20).
