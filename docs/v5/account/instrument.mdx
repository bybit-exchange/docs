...
<TabItem value="linear" label="Linear/Inverse" default>
    <table border="0.8">
        ...
        <tr>
            <td>> isPublicRpi </td><td>string</td><td>Whether RPI Is Openly Provided to Market Makers or not.<li> true: RPI Is Openly Provided to Market Makers</li> <li>false: RPI Is Not Openly Provided to Market Makers</li> </td>
        </tr>
        <tr>
            <td>> myRpiPermission </td><td>string</td><td>Whether the Current User Has RPI Permissions or not<li> true: Has RPI Permissions</li> <li>false: Does Not Have RPI Permissions</li> </td>
        </tr>
    </table>
</TabItem>
