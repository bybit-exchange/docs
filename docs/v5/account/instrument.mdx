...
<TabItem value="linear" label="Linear/Inverse" default>
    <table border="0.8">
        ...
        <tr>
            <td>> isPublicRpi</td><td>boolean</td><td>Indicates whether RPI quoting is enabled for this symbol.<ul><li><code>true</code>: All users can submit RPI orders.</li><li><code>false</code>: RPI orders are disabled for this symbol, and no users can submit them.</li></ul><strong>Note:</strong> The value may be delayed by up to 1 hour.</td>
        </tr>
        <tr>
            <td>> myRpiPermission </td><td>boolean</td><td><b>Deprecated</b>, and will always have the same value as <code>isPublicRpi</code></td>
        </tr>
    </table>
</TabItem>
