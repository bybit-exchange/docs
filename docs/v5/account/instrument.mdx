...
<TabItem value="linear" label="Linear/Inverse" default>
    <table border="0.8">
        ...
        <tr>
            <td>> rpiAccess </td><td>string</td><td>whether it is a tradable RPI or not.<li> true: RPI tradable</li> <li>false: RPI non-tradable</li> </td>
        </tr>
    </table>
</TabItem>
...
```http
GET /v5/account/instruments-info?category=linear&symbol=BTCUSDT HTTP/1.1
