...
:::info
* **Support [UTA2.0](../acct-mode#uta-20):** <br/>USDT Perpetuals, USDC Perpetuals, USDC Futures, Inverse Perpetuals, Inverse Futures [DERIVATIVES]<br/>Spot [SPOT]<br/>Options [OPTIONS]
* **Support [UTA1.0](../acct-mode#uta-10):** <br/>USDT Perpetuals, USDC Perpetuals, USDC Futures [DERIVATIVES]<br/>Spot [SPOT]<br/>Options [OPTIONS]
:::
