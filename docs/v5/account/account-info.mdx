...
## Changes on 18 June
* `dcpStatus` will be depreciated, and set as `"OFF"` permanently when new DCP is online_
* `timeWindow` will be depreciated, and set as `0` permanently when new DCP is online
* Please use [Get DCP Info](dcp-info#) to get relevant data
