...
:::info
* This switch does not work for the inverse trading in UTA1.0, which margin mode is set per symbol. Please use [Switch Cross/Isolated Margin](../position/cross-isolate#)
:::
