...
|> collateralRatio |string |Due to the new Tiered Collateral value logic, this field will no longer be accurate starting on February 19, 2025. Please wait for the launch of the Tiered Collateral Ratio interface|
