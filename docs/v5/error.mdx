...
| 110001 |There's no record of the order. |
...
|Code |Description |
|:----:|:-------------------------------|
| 176002 |Query user account info error |
...
| 176008 |You haven't enabled Cross Margin Trading yet. To do so |
| 176009 |You haven't enabled Cross Margin Trading yet. To do so |
...
| 176031 |Number of decimals has exceeded the maximum precision |
