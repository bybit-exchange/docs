...
|Code |Description |
|:----:|:-------------------------------|
| 12212 |You will get this retCode when you send cancel request after the first cancel request is accepted. In general, it means our system is processing your cancel request, no need to send cancel again |
...
| 170214 |Spot trade is restricted because otc ltv triggers risk level |
| 170215 |Spot buy trade is restricted because otc ltv triggers buy risk level |
