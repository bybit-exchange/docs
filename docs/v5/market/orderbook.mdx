...
|cts |integer |The timestamp from the match engine when this orderbook data is produced. It can be correlated with `T` from [public trade channel](../websocket/public/trade#). _`linear`, `inverse` have this field_|
