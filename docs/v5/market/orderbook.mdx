...
* Contract: 200-level of orderbook data
...
|limit |false |integer |Limit size for each bid and ask<ul><li>`spot`: [`1`, `200`]. Default: `1`.</li><li>`linear`&`inverse`: [`1`, `200`]. Default: `25`.</li><li>`option`: [`1`, `25`]. Default: `1`.</li></ul>|
...
|u |integer |Update ID, is always in sequence<ul><li>For contract, it is corresponding to `u` in the wss 200-level orderbook</li><li>For spot, it is corresponding to `u` in the wss 200-level orderbook</li></ul> |
