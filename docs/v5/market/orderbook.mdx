...
|u |integer |Update ID, is always in sequence<ul><li>For future, it is corresponding to `u` in the wss 200-level orderbook</li><li>For spot, it is corresponding to `u` in the wss 200-level orderbook</li></ul> |
