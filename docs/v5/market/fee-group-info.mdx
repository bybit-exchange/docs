...
Query for [group fee sturcture](https://www.bybit.com/en/help-center/article/Group-Fee-Structure-Symbol-Grouping) information and fee rate.

For more details please refer to [fee sturcture update announcement](https://announcements.bybit.com/article/bybit-fee-structure-update-for-pro-and-market-maker-clients-blt06875b6d623e7581/).

> **Covers: USDT Perpetual**

:::info
* **Weighted Maker volume** = Σ(Maker volume on pair × Group weighting factor (`weightingFactor`))
* **Weighted Maker share** = (Your total weighted Maker volume ÷ Bybit's total weighted Maker volume)<br/>
