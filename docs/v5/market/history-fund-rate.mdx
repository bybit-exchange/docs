...
|startTime |<div class="tooltip">false<span class="tooltiptext">If passed, `endTime` is also required</span></div> |integer |The start timestamp (ms)|
|endTime |<div class="tooltip">false<span class="tooltiptext">Required if you passed `startTime`. Otherwise, it can be passed on its own.</span></div> |integer |The end timestamp (ms)|
