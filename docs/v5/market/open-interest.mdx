...
|list |array |Object |
|> openInterest |string |Open interest. The value is the sum of both sides. <br/>The unit of value is quote coin, e.g., BTCUSD(inverse) is USD, BTCUSDT(linear) is BTC |
