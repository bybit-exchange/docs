...
* Please note that once executed, you will get execType=`MovePosition` entry from [Get Execution](execution#), [Get Closed Pnl](close-pnl#), and stream from [Execution](../websocket/private/execution).
:::
...
|> status |string |Statue. `Processing`, `Rejected`|
