...
:::tip
[UTA2.0](../acct-mode#uta-20) inverse contract move position is supported now
:::
...
|> [category](../enum#category) |**true** |string |Product type <ul><li>[UTA2.0](../acct-mode#uta-20):`linear`, `spot`, `option`,`inverse` </li><li> [UTA1.0](../acct-mode#uta-10): `linear`, `spot`, `option`</li></ul>|
