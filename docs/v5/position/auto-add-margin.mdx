...
> **Unified account covers**: USDT perpetual / USDC perpetual / USDC futures<br/>
...
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <ul><li>Unified account: `linear`</li><li>Classic account: `linear`</li></ul> |
