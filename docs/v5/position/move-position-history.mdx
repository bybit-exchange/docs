...
|nextPageCursor |false |string |Cursor. Use the `nextPageCursor` token from the response to retrieve the next page of the result set|
...
```json
{
    ...
    "result": {
        ...
        "cursor": "page_token%3D1241742%26"
    },
    "retExtInfo": {},
    "time": 1697523024386
}
