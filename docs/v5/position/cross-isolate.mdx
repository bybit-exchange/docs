...
> **UTA1.0 covers: Inverse contract**<br/>
> **Classic covers: USDT perpetual / Inverse contract**
...
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <ul><li>UTA2.0: not supported</li><li>UTA1.0: `inverse`</li><li>Classic: `linear`, `inverse`</li></ul> |
