...
> **Covers: USDT perpetual(Normal account)/Inverse Futures(Normal account)**
...
|:----- |:-------|:-----|------ |
|category |**true** |string |Product type. `linear`,`inverse` <ul><li>Please note that `category` is **not** involved with business logic</li><li>Unified account is not applicable</li></ul> |
