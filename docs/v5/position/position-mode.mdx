...
<table class="custom_table">
    ...
    <tr>
        <td>USDT futures</td><td><b>Support one-way & hedge-mode</b></td>
    </tr>
    <tr>
        <td>USDC perpetual</td><td><b>Support one-way & hedge-mode</b></td>
    </tr>
    <tr>
        <td>Inverse perpetual</td><td><b>Support one-way & hedge-mode</b></td>
    </tr>
    <tr>
        <td>Inverse futures</td><td><b>Support one-way & hedge-mode</b></td>
    </tr>
</table>
