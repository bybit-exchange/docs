...
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <ul><li> [UTA2.0](../acct-mode#uta-20): `linear`, USDT Perp</li><li> [UTA1.0](../acct-mode#uta-10): `linear`, USDT Perp; `inverse`, Inverse Futures</li><li>Classic: `linear`, USDT Perp; `inverse`, Inverse Futures</li></ul> |
