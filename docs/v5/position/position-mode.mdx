...
> **UTA2.0 covers: USDT perpetual**<br/>
> **UTA1.0 covers: USDT perpetual / Inverse Futures**<br/>
> **Classic covers: USDT perpetual / Inverse Futures**
...
<table class="custom_table">
    ...
    <tr>
        <td>USDC perpetual</td><td>Support one-way <b>only</b></td><td>Support one-way <b>only</b></td><td>Support one-way <b>only</b></td>
    </tr>
     <tr>
        <td>USDC futures</td><td>Support one-way <b>only</b></td><td>Support one-way <b>only</b></td><td>Support one-way <b>only</b></td>
    </tr>
    <tr>
...
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |Product type <ul><li> UTA2.0: `linear`, USDT Perp</li><li> UTA1.0: `linear`, USDT Perp; `inverse`, Inverse Futures</li><li>Classic: `linear`, USDT Perp; `inverse`, Inverse Futures</li></ul> |
