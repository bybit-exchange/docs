...
> **Unified account covers: USDT perpetual / Inverse Futures**<br/>
...
<table class="custom_table">
    ...
    <tr>
        <td>USDT perpetual</td><td><b>Support one-way & hedge-mode</b></td><td><b>Support one-way & hedge-mode</b></td>
    </tr>
    <tr>
        <td>USDC perpetual</td><td>Support one-way <b>only</b></td><td>Support one-way <b>only</b></td>
    </tr>
    <tr>
        <td>Inverse perpetual</td><td>Support one-way <b>only</b></td><td>Support one-way <b>only</b></td>
    </tr>
    <tr>
        <td>Inverse future</td><td><b>Support one-way & hedge-mode</b></td><td><b>Support one-way & hedge-mode</b></td>
    </tr>
</table>
...
|:----- |:-------|:-----|------ |
|[category](../v5/enum#category) |**true** |string |Product type <ul><li> Unified account: `linear`, USDT Perp; `inverse`, Inverse Futures</li><li>Classic account: `linear`, USDT Perp; `inverse`, Inverse Futures. _Please note that `category` is **not** involved with business logic_</li></ul> |
