...
> **Cover: Linear contract(Unified Account) / Option(Unified Account)**
...
|list|array |Object |
|> [positionIdx](../v5/enum#positionidx) | integer |Position idx, used to identify positions in different position modes.<li>`0`: One-Way Mode</li>|
