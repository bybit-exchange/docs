...
|list|array |Object |
|> [positionIdx](../enum#positionidx) | integer |Position idx, used to identify positions in different position modes.<li>`0`: One-Way Mode</li><li>`1`: Buy side of both side mode</li><li>`2`: Sell side of both side mode</li>|
