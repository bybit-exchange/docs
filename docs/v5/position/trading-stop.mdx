...
|tpSize |false |string |Take profit size. Valid in TP/SL partial mode. _note: partial TP/SL valid for USDT Perpetual **only**_ |
|slSize |false |string |Stop loss size. Valid in TP/SL partial mode. _note: partial TP/SL valid for USDT Perpetual **only**_ |
