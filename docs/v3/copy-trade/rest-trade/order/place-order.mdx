...
|[tpTriggerBy](../enumtriggerby) |false |string |Type of take-profit activation price, `LastPrice` by default |
|[slTriggerBy](../enumtriggerby) |false |string |Type of stop-loss activation price, `LastPrice` by default |
