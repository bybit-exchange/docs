...
|withdrawType |false |string |<li>`0 (default)`：on chain.</li> <li>`1`：off chain.</li><li> `2`：on and off chain</li>|
...
|withdrawType|int|Withdraw type. <li>`0`：on chain;</li> <li>`1`：internal address transfer</li>|
