...
The API rate limit is based on the **rolling time window per second/minute and UID**. In other words, it is per second/minute per UID.
...
<table border="0.8">
    ...
    <tr>
        <td>/asset/v3/private/deposit/sub-member-record/query</td><td rowSpan="5">300 req/s</td>
    </tr>
    <tr>
