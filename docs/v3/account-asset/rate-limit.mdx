...
<table border="0.8">
    ...
    <tr>
        <td>/asset/v3/private/transfer/sub-member-transfer</td><td rowSpan="2">20 req/min</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/asset/v3/private/transfer/inter-transfer</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/asset/v3/private/transfer/universal-transfer/list/query</td><td>5 req/sec</td>
    </tr>
    <tr>
        <td>/asset/v3/private/transfer/account-coins/balance/query</td><td>5 req/sec</td>
    </tr>
</table>
</span>
...
<table border="0.8">
    ...
    <tr>
        <td>/asset/v3/private/coin-info/query</td><td>5 req/sec</td>
    </tr>
    <tr>
        <td>/asset/v3/private/withdraw/cancel</td><td>60 req/min</td>
    </tr>
    <tr>
        <td>/asset/v3/private/withdraw/create</td><td>1 req/s</td>
    </tr>
</table>
</span>
