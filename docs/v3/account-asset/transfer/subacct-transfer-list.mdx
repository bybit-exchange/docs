...
|status |false |string |Transfer status<li>SUCCESS</li><li>PENDING</li><li>FAILED</li>|
...
|status|string |status<li>SUCCESS</li><li>PENDING</li><li>FAILED</li> |
|type |string |Determines the direction of transfer.<li>`IN` transfer from main account to subaccount</li><li>`OUT` transfer from subaccount to main account</li> |
