...
|type |<b>true</b> |string |Determines the direction of transfer.<li>`IN` transfer from main account to subaccount</li><li>`OUT` transfer from subaccount to main account</li> |
