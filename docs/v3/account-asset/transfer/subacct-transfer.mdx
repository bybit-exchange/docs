...
To send a transfer which is [accountType](../enum#accounttype) & parent/sub agnostic, use the <a href="uni-transfer">Create Universal Transfer</a> endpoint.
...
|subMemberId |<b>true</b> |string |Subaccount userid |
