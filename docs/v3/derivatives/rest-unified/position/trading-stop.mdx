...
|:----- |:-------|:-----|------ |
|[category](../../v3/derivatives/enum#category) |**true** |string |Product type. `linear` |
...
|[tpTriggerBy](../../v3/derivatives/enum#triggerby) |false |string |Take profit trigger price type. default: `LastPrice` |
|[slTriggerBy](../../v3/derivatives/enum#triggerby) |false |string |Stop loss trigger price type. default: `LastPrice` |
...
|[positionIdx](../../v3/derivatives/enum#positionidx) |**true** |string |Used to identify positions in different position modes. `0`: one-way mode for unified margin only |
