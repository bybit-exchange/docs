...
<table border="0.8">
    ...
    <tr>
        <td>/unified/v3/private/order/create</td><td rowSpan="3">800 req/min (shared)</td><td>5 req/s</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/unified/v3/private/order/create-batch</td><td rowSpan="4">800 req/min (shared)<br/></td><td>5 req/s</td>
    </tr>
    <tr>
