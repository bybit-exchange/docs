...
### 110013
Due to risk limit, cannot set leverage

### 110014
Available balance not enough to add margin
...
### 110020
number of active orders greater than 500
...
### 110031
risk limit info does not exists
...
### 110039
Maintain margin rate is too high, which may trigger liquidation
...
### 110050
Coin is not in the range of selected
...
### 110061
Under partial TP/SL mode, TP/SL set more than 20
...
### 110067
unified account is not support

### 110068
Leveraged user trading is not allowed

### 110069
Do not allow OTC lending users to trade

### 110070
ETP symbols are not allowed to be traded
