...
|list |array |<ul><li>An string array of individual candle</li><li>Sort in reverse by `start`</li><li>The default collation within the array is `start`, `open`, `high`, `low`, `close`, `volume`, `turnover`</li> </ul>|
