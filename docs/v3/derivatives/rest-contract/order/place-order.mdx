...
For the minimum unit of the price change, please refer to the priceFilter field in the [instrumentInfo](../../rest-public/instrument-info#).
...
|positionIdx |false |string |Position mode. `0`: one-way mode. `1`: Buy side of hedge mode. `2`: Sell side of hedge mode |
