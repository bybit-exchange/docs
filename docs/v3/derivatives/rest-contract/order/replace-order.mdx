...
|tpLimitPrice |false |string |**(testnet)** Limit order price when take profit is triggered. Only working when original order sets partial limit tp/sl|
|slLimitPrice |false |string |**(testnet)** Limit order price when stop loss is triggered. Only working when original order sets partial limit tp/sl|
