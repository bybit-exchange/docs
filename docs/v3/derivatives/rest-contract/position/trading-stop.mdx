...
Set the take profit, stop loss or trailing stop for the position. If under [Tp/SL partial mode](tpsl-mode#), TP/SL/TS orders will not close your entire position.
...
|positionIdx |**true** |string |Used to identify positions in different position modes. <ul><li>`0`: one-way mode</li><li>`1`: hedge-mode Buy side</li><li>`2`: hedge-mode Sell side</li> </ul>|
